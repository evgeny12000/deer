...
var readAchievementsPageGenerator_1 = require("./readAchievementsPageGenerator");
function runTest() {
    return __awaiter(this, void 0, void 0, function () {
        var testStream, generator, _a, generator_1, generator_1_1, achievementsBatch, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    testStream = new stream_1.Readable({
                        read: function () { }
                    });
                    ...
                    generator = (0, readAchievementsPageGenerator_1.readAchievementsPageGenerator)(testStream);
                    _e.label = 1;
                case 1:
...
runTest().catch(function (err) { return console.error("Error during test:", err); });
